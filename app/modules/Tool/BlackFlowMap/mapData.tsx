...
import { nodeId, edgeKey } from "./gridUtils";

export const zoneNotes: Record<string, string> = {
  zone_1:
...
export const nodeOptions: nodeOption[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { zone: "zone_4", min: 3, max: 12, maxAllowed: 3 },
  ...
  },
  {
    ...
    steps: [
      ...
      { zone: "zone_5", min: 4, max: 14, maxAllowed: 1 },
    ],
    type: "battle",
  },
  {
    ...
    name: "诡意行商",
    steps: [
      { zone: "zone_1", min: 2, max: 4, maxAllowed: 2 },
      { zone: "zone_2", min: 3, max: 6, maxAllowed: 1 },
      { zone: "zone_3", min: 3, max: 6, maxAllowed: 1 },
      { zone: "zone_4", min: 2, max: 13, maxAllowed: 3 },
      { zone: "zone_5", min: 1, max: 14, maxAllowed: 3 },
    ],
    type: "other",
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      { zone: "zone_3", min: 4, max: 14, maxAllowed: 1 },
  ...
  },
  {
    ...
    steps: [
      ...
      { zone: "zone_2", min: 2, max: 7, maxAllowed: 3 },
      { zone: "zone_3", min: 1, max: 15, maxAllowed: 4 },
      { zone: "zone_4", min: 1, max: 14, maxAllowed: 4 },
      { zone: "zone_5", min: 1, max: 14, maxAllowed: 4 },
    ],
    type: "other",
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      { zone: "zone_5", min: 1, max: Infinity, maxAllowed: 7 },
    ],
    type: "other",
  },
  {
    ...
    steps: [
      { zone: "zone_2", min: 3, max: 5, maxAllowed: 1 },
      { zone: "zone_3", min: 3, max: 6, maxAllowed: 1 },
      { zone: "zone_4", min: 2, max: 4, maxAllowed: 1 },
      { zone: "zone_5", min: 2, max: 12, maxAllowed: 2 },
    ],
    type: "other",
  },
  {
    ...
    name: "先行一步",
    steps: [
      { zone: "zone_2", min: 2, max: 4, maxAllowed: 1 },
  ...
  },
  {
    ...
    name: "曲折密道",
    steps: [
      { zone: "zone_3", min: 1, max: 15, maxAllowed: 2 },
      { zone: "zone_4", min: 1, max: 14, maxAllowed: 2 },
      { zone: "zone_5", min: 1, max: 14, maxAllowed: 2 },
    ],
    type: "other",
  },
  {
    ...
    steps: [
      { zone: "zone_2", min: 3, max: 6, maxAllowed: 1 },
      { zone: "zone_3", min: 4, max: 7, maxAllowed: 1 },
      { zone: "zone_4", min: 3, max: 8, maxAllowed: 2 },
      { zone: "zone_5", min: 5, max: 8, maxAllowed: 1 },
    ],
    type: "other",
  },
  {
...
export const nodeTypeLimits: nodeTypeLimit[] = [
  {
    type: "other",
    steps: [
      { zone: "zone_1", maxAllowed: 6 },
      { zone: "zone_2", maxAllowed: 9 },
      { zone: "zone_3", maxAllowed: 13 },
      { zone: "zone_4", maxAllowed: 14 },
      { zone: "zone_5", maxAllowed: 18 },
    ],
  },
  {
    type: "battle",
    steps: [
      { zone: "zone_1", maxAllowed: 6 },
      { zone: "zone_2", maxAllowed: 7 },
      { zone: "zone_3", maxAllowed: 7 },
      { zone: "zone_4", maxAllowed: 8 },
      { zone: "zone_5", maxAllowed: 11 },
    ],
  },
];

export interface MapShorthand {
  id: string;
  zone: string;
  rows: number;
  cols: number;
  start: [number, number]; // [r, c]
  ends?: [number, number][]; // [[r, c], ...]
  battleEnd?: [number, number]; // [[r, c], ...]
  edges: [number, number, number, number][]; // [r1, c1, r2, c2]
  notes?: string;
  knownBattles?: [number, number][];
  knownShops?: [number, number][];
}

export function toGridState(m: MapShorthand): GridState {
  const connections: GridState["connections"] = {};
  for (const [r1, c1, r2, c2] of m.edges) {
...
export const initialMaps: MapShorthand[] = [
  ...
  },
  {
    ...
    knownBattles: [[0, 3]],
    notes:
      "该基底下有较高概率生成紧急作战/居民据点；若该基底战斗节点总数较少，则大概率生成险路小径",
  },
  {
    id: "2f",
    zone: "zone_2",
  ...
  },
  {
    ...
    notes:
      "该基底整体较小，步长分散，较容易出现极端穷的情况；该基底理论上误入奇境生成概率较高，与实测结论有冲突",
  },
  {
    id: "3c",
    zone: "zone_3",
  ...
  },
  {
    ...
    notes: "该基底的出现概率较低；该基底下有较高概率生成险路小径",
  },
  {
    id: "4c",
    zone: "zone_4",
  ...
  },
  {
    ...
    notes: "该基底整体较小；该基底下较高概率生成多个紧急作战/居民据点",
  },
  {
    id: "4j",
    zone: "zone_4",
    ...
    notes:
      "该基底下较多生成双羽瞰点；从全体样本来看，该基底生成高价值节点概率较高",
  },
  {
    id: "5a",
    zone: "zone_5",
    ...
    notes: "该基底下多次出现大量高质量战斗，多见4+个紧急作战/居民据点",
  },
  {
    id: "5b",
    zone: "zone_5",
