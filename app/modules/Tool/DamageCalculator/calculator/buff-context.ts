...
export interface IBuffContext {
  ...
  in_game_buff_add: {
    ...
    /** 敌人攻击速度改变 */
    enemy_attack_speed: ExpressionGroupNode;
  };
  /** 局内Buff 直接乘算 */
  in_game_buff_mul: {
    /** 攻击力 */
  ...
  in_game_buff_final_mul: {
    ...
    /** 物理闪避率 */
    evade_physical: ExpressionGroupNode;
    /** 法术闪避率 */
    evade_magical: ExpressionGroupNode;
    /** 敌人攻击力改变来源 */
    enemy_atk: ExpressionGroupNode;
    /** 敌人防御力减少来源 */
    enemy_def: ExpressionGroupNode;
...
export class BuffContext implements IBuffContext {
  ...
  relic_rune_mul: IBuffContext["relic_rune_mul"] = {
    ...
    cost: new ExpressionGroupNode("+", "局外乘算").addChild(new NumericLiteralNode(1, "基数")),
  ...
  in_game_buff_mul: IBuffContext["in_game_buff_mul"] = {
    ...
    def: new ExpressionGroupNode("+", "局内直接乘算").addChild(new NumericLiteralNode(1, "基数")),
  };
  ...
  in_game_buff_final_mul: IBuffContext["in_game_buff_final_mul"] = {
    ...
    evade_physical: new ExpressionGroupNode("union", "局内取并集乘算").addChild(new NumericLiteralNode(0, "基数")),
    evade_magical: new ExpressionGroupNode("union", "局内取并集乘算").addChild(new NumericLiteralNode(0, "基数")),
  ...
  clone() {
    ...
    clone.relic_rune_mul = {
      ...
      cost: this.relic_rune_mul.cost.clone(),
    ...
    clone.in_game_buff_mul = {
      ...
      def: this.in_game_buff_mul.def.clone(),
    };
    ...
    clone.in_game_buff_final_mul = {
      ...
      evade_physical: this.in_game_buff_final_mul.evade_physical.clone(),
      evade_magical: this.in_game_buff_final_mul.evade_magical.clone(),
