...
| 改上游同步自动化（`arkrog_backend/util-scripts/gamedata-sync.sh`、其 cron 调度或新主题闸门判据）                                                                                                                                                                                                        | 更新 [docs/gamedata-auto-sync-plan.md](docs/gamedata-auto-sync-plan.md)；若改的是运维口径（命令、频率、两遍执行），同步 [docs/data-pipeline.md](docs/data-pipeline.md) 第 3.5 节                                                                                                                                                                   |
